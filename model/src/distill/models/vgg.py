...
class VGG(nn.Module):
    ...
    def __init__(self, cfg, batch_norm=False, num_classes=1000, in_ch=3):
        super(VGG, self).__init__()
        self.block0 = self._make_layers(cfg[0], batch_norm, in_ch)
...
def vgg19_32(**kwargs):
    model = VGG(cfg['E'], in_ch=32, batch_norm=True, **kwargs)
    return model
