...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, num_filters, block_name='BasicBlock', in_ch=3, num_classes=10):
        ...
        self.conv1 = nn.Conv2d(in_ch, num_filters[0], kernel_size=3, padding=1,
                               bias=False)
...
def resnet8_8(**kwargs):
    return ResNet(in_ch=32, depth=8, num_filters=[64, 64, 128, 128, 512], block_name='basicblock', **kwargs)
