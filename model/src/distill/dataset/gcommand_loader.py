...
def spect_loader(path, window_size, window_stride, window, normalize, max_len=100):
...
class GCommandLoader(data.Dataset):
    ...
    def __init__(self, root, transform=None, target_transform=None, window_size=.02,
                #  window_stride=.01, window_type='hamming', normalize=True, max_len=101):
                 window_stride=.01, window_type='hamming', normalize=True, max_len=100):
    ...
    def __getitem__(self, index):
        ...
        spect = spect[0][:160].reshape(1,160,100)
