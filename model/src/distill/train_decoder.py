...
from helper.decoder_loops import train_distill as train, validate
...
def parse_option():
    ...
    # dataset
    parser.add_argument('--dataset', type=str, default='cifar10', choices=['cifar100', 'cifar10', 'mnist', 'fashion',
                                                                           'stl10', 'speech'], help='dataset')
    ...
    parser.add_argument('--model_s', type=str, default='resnet8',
                        choices=['resnet8', 'resnet14', 'resnet20', 'resnet32', 'resnet44', 'resnet56', 'resnet110',
                                 ...
                                 'iRevNet8x112', 'iRevNet4_32', 'iRevNet32x192', 'iRevNet20x320', 'iRevNet8x384', 'iRevNet32x56',
                                 'iRevNet16x56', 'iRevNet48x56', 'iRevNet64x56', 'iRevNet16x64', 'iRevNet64x64', 'iRevNet48x64',
                                 'iRevNet40x320'])
    ...
    parser.add_argument('--et', action="store_true", default=False, help="if evaluate teacher or not")
    parser.add_argument('--es', action="store_true", default=False, help="if evaluate student or not")
    ...
    if hostname.startswith('visiongpu'):
        ...
        opt.model_path = './save/models/iRevNet18'
        opt.tb_path = './logs/student_tensorboards'
...
def main():
    ...
    if opt.dataset == 'fashion':
        model_t = TeacherModel(teacher, opt.ec_k, 'fashion')
    else:
        model_t = TeacherModel(teacher, opt.ec_k)

    data = torch.randn(opt.ec_k, 512, 8, 8)
    model_t.eval()
    model_s.eval()
    if opt.distill == 'hint':
    ...
    if opt.et:
        teacher_acc, _, _ = validate(val_loader, teacher, model_t, criterion_cls, opt, teacher=True)
        print('teacher accuracy: ', teacher_acc)
        return
        
    if opt.es:
        student_acc, _, _ = validate(val_loader, teacher, model_s, criterion_cls, opt, teacher=False)
    ...
    for epoch in range(1, opt.epochs + 1):
        ...
        test_acc, tect_acc_top5, test_loss = validate(val_loader, teacher, model_s, criterion_cls, opt)
